...
class ListUsers extends ListRecords
{
    ...
    public function getTabs(): array
    {
        ...
        $tabs = [
            null => Tab::make('All'),
            'pemilik Warung' => Tab::make()->query(fn($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'pemilik_warung')),
            'pembeli' => Tab::make()->query(fn($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'pembeli')),
        ];
